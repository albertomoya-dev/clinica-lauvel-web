...
const svg = `<svg width="1200" height="630" viewBox="0 0 1200 630" xmlns="http://www.w3.org/2000/svg">
  <rect width="1200" height="630" fill="#FDF2F7"/>
  <rect y="560" width="1200" height="70" fill="#D7006B"/>
  <circle cx="1050" cy="120" r="220" fill="#FEFAFC"/>
  <circle cx="120" cy="500" r="140" fill="#F6D9E8" opacity="0.6"/>
  ...
  <text x="600" y="365" font-family="Segoe UI, Arial, sans-serif" font-size="110" font-weight="700" letter-spacing="18" fill="#D7006B" text-anchor="middle">LAUVEL</text>
